      ...
      <View className="mb-4">
        ...
        <View className="bg-background-muted flex-row items-center rounded-lg p-1">
          ...
          <Pressable onPress={showFilters} className="p-1">
            <View className={`rounded-md p-2 ${filtersActive ? 'bg-accent' : 'bg-transparent'}`}>
              <FontAwesome5 name="sliders-h" size={18} color={filtersActive ? '#121517' : '#fff'} />
            </View>
          </Pressable>
        </View>
      ...
      {Platform.OS !== 'web' && (
        <BottomSheet
          ...
          <BottomSheetView className="p-4">
            <BottomSheetView className="mb-4 flex-row items-center justify-between border-b border-secondary-850 pb-2">
