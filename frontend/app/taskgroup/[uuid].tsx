...
export default function Tasks() {
  ...
  const handleNewNoteSheetChanges = useCallback((index: number) => {
    console.log("handleNewNoteSheetChanges ", index, isNewTask, settingsOpen);
    if (index == -1) setIsNewTask(false);
  }, []);

  const handleSettingsSheetChanges = useCallback((index: number) => {
    console.log("handleSettingsSheetChanges ", index, isNewTask, settingsOpen);
    if (index == -1) setIsNewTask(false);
  }, []);
        ...
        <View className="flex flex-col gap-8 mx-8 my-4">
          ...
          <View className="flex flex-row gap-2 items-center">
            {isEditName ? (
              <TextInput
                value={newName}
                onChangeText={(name) => setNewName(name.substr(0, 50))}
            ...
            {isEditDescription ? (
              <TextInput
                ...
                onChangeText={(description) =>
                  setNewDescription(description.substr(0, 200))
                }
            ...
            <BottomSheetView>
              <View className="flex flex-col p-8 pb-10 gap-4">
                ...
                <Pressable
                  ...
                  onPress={() => createTask()}
                >
                  <Text className="text-background text-center">Add Task</Text>
                </Pressable>
              </View>
            </BottomSheetView>
          </BottomSheetModal>
            ...
            <BottomSheetView>
              <View className="flex flex-col p-8 pb-10 gap-4">
                <View className="flex flex-row gap-2">
                  ...
                  <Pressable className="bg-accent p-2 rounded-xl flex-1">
